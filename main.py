...
def run():
    ...
    if escolha == 1:
        data_colector.cliente = 'Player1'
        xtoken = ''
        env_data.cliente = 'Player1'
    elif escolha == 2:
        data_colector.cliente = 'Player2'
        xtoken = '' 
        env_data.cliente = 'Player2'
    elif escolha == 3:
        data_colector.cliente = 'Player3'
        xtoken = ''
        env_data.cliente = 'Player3'
    else:
